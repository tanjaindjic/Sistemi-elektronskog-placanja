...
public class BankRequestDTO {
	...
	public BankRequestDTO(@NotNull String merchantID, @NotNull String merchantPass, @NotNull double iznos,
	...
	public String toString() {
		return "BankRequestDTO [merchantID=" + merchantID + ", merchantPass=" + merchantPass + ", iznos=" + iznos

...
public interface MainService {
    ...
    ResponseEntity<Map> paymentFailed(PaymentInfo paymentInfo, Transakcija t, String token, PaymentDTO paymentDTO) throws JsonProcessingException;
    ResponseEntity<Map> finishPayment(PaymentInfo paymentInfo, Transakcija t, String token, PaymentDTO paymentDTO) throws JsonProcessingException;
    PaymentInfo createPaymentDetails(RequestDTO request);
}
